---
description: "Use CodeGraph for structural/codebase questions"
trigger: always_on
---
...
- Every worktree needs its own `.codegraph/` index. Never copy, symlink, or reuse another checkout's index because the root and checked-out bytes may differ.
